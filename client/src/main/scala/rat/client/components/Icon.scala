...
object Icon {
  ...
  def refreshAnimateLarge:Icon = <.i(^.className := "fa fa-refresh fa-spin fa-4x")
  def spinnerAnimateLarge:Icon = <.i(^.className := "fa fa-spinner fa-pulse fa-4x")
